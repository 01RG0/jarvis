...
def plan_node(state: TaskState) -> TaskState:
    res = call_llm("balanced", "Break this task into steps:\n" + state["input"])
...
def build_graph() -> StateGraph:
    ...
    g.add_conditional_edges("route_node", _route_after_route, {"fast": "fast_node", "slow": "plan_node"})
    g.add_edge("fast_node", "output_node")
